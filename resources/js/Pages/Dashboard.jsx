            ...
            <div className="pt-12 mx-auto max-w-screen min-w-screen">
                <div className='flex flex-col justify-center items-center my-10 px-5'>
                    <div className='text-center mb-10'>
                        <h2 className='text-5xl font-bold'>About VoteLinker</h2>
                    ...
                    <div className='flex flex-col md:flex-row justify-center items-center gap-8'>
                        ...
                        <div className='flex flex-col gap-5 text-justify max-w-lg animate-fadeInRight'>
                            ...
                            <p className='text-gray-600 text-xl'>It provides a simple and accessible voter experience that easily combines multiple engagements around voting.</p>
                            <p className='text-gray-600 text-xl'>VoteLinker is available throughout the Student Executive Board in each faculty at IPB University to carry out seamless electronic voting with the highest security and integrity.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col justify-center items-center mt-10'>
                        <h2 className='text-4xl font-bold animate-fadeIn'>Why Choose VoteLinker?</h2>
                        ...
                        <ul className='list-disc text-left mt-4 space-y-2 max-w-lg text-gray-600'>
                            <li className='animate-fadeInLeft text-lg'>Highly secure with end-to-end encryption</li>
                            <li className='animate-fadeInRight text-lg'>User-friendly interface for ease of use</li>
                            <li className='animate-fadeInLeft text-lg'>Real-time vote counting and results</li>
                            <li className='animate-fadeInRight text-lg'>Accessibility features for all users</li>
                            <li className='animate-fadeInLeft text-lg'>Comprehensive support and training</li>
                        </ul>
                    </div>
